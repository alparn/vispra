...
/**
 * Maps X11 keysym names to their Unicode code points.
 *
 * Generated from:
 * grep "#define XKB_KEY_" /usr/include/xkbcommon/xkbcommon-keysyms.h
 */
export const KEYSYM_TO_UNICODE: Readonly<Record<string, number>> = {
  space: 0x0020,
  exclam: 0x0021,
  quotedbl: 0x0022,
  numbersign: 0x0023,
...
/**
 * Reverse mapping: unicode character -> keysym name.
 * Built from KEYSYM_TO_UNICODE at module load time.
 */
...
for (const keysym in KEYSYM_TO_UNICODE) {
  ...
  CHAR_TO_NAME[String.fromCharCode(u)] = keysym;
}
